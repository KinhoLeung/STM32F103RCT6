...
_m_tp_dev tp_dev = {
    tp_init, tp_scan, NULL, 0, 0, 0, 0, 0, 0, 0, 0,
};

void delay_us(uint32_t us) {
  uint32_t count = us * 24;
  while (count--) {
    __NOP();
  }
}
...
/* 提示字符串 */
// char *const TP_REMIND_MSG_TBL = "Please use the stylus click the cross on the "
//                                 "screen.The cross will always move until "
